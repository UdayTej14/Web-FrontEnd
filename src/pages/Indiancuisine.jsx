// src/components/IndianCuisine.js
...
const Indiancuisine = () => {
   ...
   useEffect(() => {
      // Fetch Indian recipes from backend
      const fetchRecipes = async () => {
         try {
            const response = await axios.get(`http://localhost:5010/api/recipes/Indian`);
   ...
   return (
      <div className="p-4">
         <h2 className="text-2xl font-bold mb-4">Indian Cuisine</h2>
